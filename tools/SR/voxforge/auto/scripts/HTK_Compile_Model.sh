...
make_lexicon () {
	if [ -f "../../lexicon/obelisk_lexicon" ]; then
		echo "Found obelisk_lexicon"
	else
		echo "Error!! ../../lexicon/obelisk_lexicon not found!"
		return 1
	fi
	return 0
}
...
make_treehed () {
    ...
    perl ../../HTK_scripts/mkclscript.prl TB 350 ./interim_files/monophones0 >> ./interim_files/tree.hed
...
print_heading "Step 10 - Making Tied-State Triphones"
	HDMan -A -D -T 1 -b sp -n ./interim_files/fulllist -g ./input_files/global.ded -l logs/Step10_HDMan.flog ./interim_files/dict-tri ../../lexicon/obelisk_lexicon > logs/Step10_HDMan.log
	make_fulllist  
	make_treehed
	echo -e 'making hmm13\n'
